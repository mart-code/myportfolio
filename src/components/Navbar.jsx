...
const Navbar = () => {
  ...
  return (
    <div className="fixed w-full h-[80px] flex justify-between items-center px-4 bg-slate-950 z-50 text-gray-300">
      <div>{/* <img src= alt="Logo Image" style={{width: '50px'}} /> */}</div>
